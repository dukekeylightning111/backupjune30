...
public class MySportingActivitiesActivity extends AppCompatActivity {
    ...
    public void showEditSportActivityDialog(SportingActivityClass sportingActivity) {
        TextInputLayout inputLayoutTitle = new TextInputLayout(MySportingActivitiesActivity.this);
        inputLayoutTitle.setHint("אנא הכתבו כותרת חדשה ");
        EditText inputEditText = new EditText(MySportingActivitiesActivity.this );
        inputLayoutTitle.addView(inputEditText);
        TextInputLayout inputLayoutDesc = new TextInputLayout(MySportingActivitiesActivity.this);
        inputLayoutTitle.setHint("אנא הכתבו כותרת חדשה ");
        EditText inputLayoutDesc = new EditText(MySportingActivitiesActivity.this );
        inputLayoutTitle.addView(inputEditText);
