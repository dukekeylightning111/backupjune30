...
public class NotificationBroadCast extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (sportingActivity == null) {
            ...
            String activityInfo = "פרטי הפעילות: \n" +
                    "כותרת: " + sportingActivity.getTitle() + "\n" +
                    "קטגוריה: " + sportingActivity.getCategory() + "\n" +
                    "תיאור: " + sportingActivity.getDescription() + "\n" +
                    "זמן: " + sportingActivity.getTime() + "\n" +
                    "תאריך: " + sportingActivity.getDate() + "\n" +
                    "מיקום: " + sportingActivity.getLocation();

            createAndShowNotification(context, "פעילות ספורט", activityInfo.toString() + "");
        }
    }
